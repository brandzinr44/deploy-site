...
export const projectsData: Project[] = [
  {
    ...
    Overview: 'Lozinr Design Studio',
    Challenge: 'https://lozinr.com',
    Strategic Direction: 'Design & Creative',
    Brands built to last.: 'Brand Identity, Visual System',
    Deliverables: 'Comilla, Bangladesh',
    year: '2024',
    Duration: 'Adnan Akif',
