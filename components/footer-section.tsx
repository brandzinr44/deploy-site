    ...
    >
      ...
      <g>
        <motion.path
          ...
          transition={{ duration: 0.6, delay: 0 * 0.08, ease: 'easeOut' }}
        />
        <motion.path
          className="footer-path"
          ...
          initial={{ opacity: 0, scale: 0.9 }}
          animate={isInView ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.9 }}
          transition={{ duration: 0.6, delay: 0.08 * 0.1, ease: 'easeOut' }}
        />
        <motion.path
          className="footer-path"
          ...
          initial={{ opacity: 0, scale: 0.9 }}
          animate={isInView ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.9 }}
          transition={{ duration: 0.6, delay: 0.16 * 0.1, ease: 'easeOut' }}
        />
        <motion.path
          className="footer-path"
          ...
          initial={{ opacity: 0, scale: 0.9 }}
          animate={isInView ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.9 }}
          transition={{ duration: 0.6, delay: 0.24 * 0.1, ease: 'easeOut' }}
        />
        <motion.path
          className="footer-path"
          ...
          initial={{ opacity: 0, scale: 0.9 }}
          animate={isInView ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.9 }}
          transition={{ duration: 0.6, delay: 0.32 * 0.1, ease: 'easeOut' }}
        />
        <motion.path
          className="footer-path"
          ...
          initial={{ opacity: 0, scale: 0.9 }}
          animate={isInView ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.9 }}
          transition={{ duration: 0.6, delay: 0.4 * 0.1, ease: 'easeOut' }}
        />
      </g>
      <g>
        <motion.path
          ...
          initial={{ opacity: 0, scale: 0.9 }}
          animate={isInView ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.9 }}
          transition={{ duration: 0.6, delay: 0.48 * 0.1, ease: 'easeOut' }}
        />
        <motion.path
          className="footer-path"
          ...
          initial={{ opacity: 0, scale: 0.9 }}
          animate={isInView ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.9 }}
          transition={{ duration: 0.6, delay: 0.56 * 0.1, ease: 'easeOut' }}
        />
      </g>
    </motion.svg>
  )
