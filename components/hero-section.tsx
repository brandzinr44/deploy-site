...
export default function HeroSection({ triggerAnimation = false }: HeroSectionProps) {
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section ref={sectionRef} className="bg-background overflow-hidden pt-0 py-85 md:py-48">
        <div className="w-full px-3 lg:px-5" />
      </section>

      {/* Hero Content */}
      <section className="pt-0 md:pt-0 flex items-center justify-center min-h-[65vh] relative overflow-hidden bg-background">
        <motion.div
          ...
          <div className="flex flex-col gap-4 items-center justify-center">
            ...
            <div className="flex justify-center w-full relative z-20">
              <motion.h1
                ...
                className="text-[32px] md:text-[52px] font-medium tracking-tighter leading-[1] text-foreground text-center flex items-center justify-center flex-wrap gap-x-[0.28em]"
              >
